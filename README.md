...
- 🤖 **AI Packs**: build a custom AI in **Model Forge** (e.g. `menu-bot`), then click **🤖 Export AI Pack** — one file carries your knowledge *and* your custom AIs (name, base model, rules). Import on any device and **⟳ Rebuild** each AI from the local knowledge base; everything dedupes on re-import.
