...
const CORE = {
  ...
  citing: '1. Answer the user\'s question directly using the provided context. The context snippets are labelled [SOURCE 1], [SOURCE 2], … in order. Whenever a sentence relies on a specific fact, number, or quote from a source, end that sentence with its source number in square brackets — e.g. "…carbon steel holds heat evenly. [2]" — or "[2][5]" when several sources support one sentence. Only cite sources you genuinely used; never invent markers.',
  detail: {
